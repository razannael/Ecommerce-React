...
const {getCartContext,removeItemContext,clearCart, setDecrease,setIncrease}= useContext(CartContext);
const getCart = async ()=>{
          ...
          <div className="cart-items">
            <div className="qproducts" id="products">
              ...
              {data?.products?(
                ...
                <div className="quantity">
                {product.quantity >1 ?                   <button onClick={() => setDecrease(product.details._id)}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={16}
                      height={17}
                  ...
                  <button onClick={() => setIncrease(product.details._id)}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={16}
                      height={17}
